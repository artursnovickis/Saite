...
<head>
	<title>KIZIKWORLD</title> (loading) - </title>
...
<link href='https://fonts.googleapis.com/css?family=Arimo&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/responsive.cs') }}s" media="screen" />
		...
		<ul class="cd-slider">
			...
			<li>
				<div>
					...
					<a href="information" class="cd-btn">Vairak</a>
				</div>
			</li>
			...
			<li>
				<div>
					...
					<a href="preces" class="cd-btn">Vairak</a>
				</div>
			</li>
			...
			<li>
				<div>
					<h2>Kontakti</h2>
					<p>Musu kontakti</p>
					<a href="kontakt" class="cd-btn">Vairak</a>
				</div>
			</li>
		</ul> <!-- .cd-slider -->
		...
		<section class="call-to-action">
			<div class="container">
				...
				<div class="col-lg-12 text-center mt40">
					<a href="preces" id="cta-button-solid" class="btn btn-large btn-rounded btn-light-solid">Pirkt </a>
					<a href="information" id="cta-button-stroke" class="btn btn-large btn-rounded btn-light-transparent">Vairak</a>
				</div>
			</div>
		</section>
